...
class CamUNet(nn.Module):
    def __init__(self, input_data, window_size, embedding_dim, n_channels, n_classes, n_blocks, start_channels,
        ...
        self.channel_attention = ChannelAttentionModule(num_channels=embedding_dim * window_size)
    ...
    def forward(self, x, target_time=None):
        ...
        x = self.channel_attention(x) # Ajout d'un ChannelAttentionModule qui fait office de "preprocessing" ici
